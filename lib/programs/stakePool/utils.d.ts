 ...
 * @returns
 */
export declare const findStakeEntryIdFromMint: (stakePoolId: PublicKey, originalMintId: PublicKey) => Promise<PublicKey>;
...
export declare const getUnclaimedRewards: (connection: Connection, stakePoolId: PublicKey, distributorId: BN, stakePoolDuration: number) => Promise<BN>;
export declare const getClaimedRewards: (connection: Connection, stakePoolId: PublicKey, distributorId: BN, stakePoolDuration: number) => Promise<BN>;
