 ...
 * @returns
 */
const findStakeEntryId = (_wallet, stakePoolId, originalMintId, _isFungible = false) => {
    console.log("findStakeEntryId");
    console.log(_1.STAKE_ENTRY_SEED, stakePoolId.toString(), originalMintId.toString(), web3_js_1.PublicKey.default.toString());
    return web3_js_1.PublicKey.findProgramAddressSync([
