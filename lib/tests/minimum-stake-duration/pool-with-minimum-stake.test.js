...
describe("Create stake pool", () => {
    ...
    it("Create Pool", async () => {
        let transaction;
        [transaction, stakePoolId] = await (0, src_1.createStakePool)(provider.connection, provider.wallet, { minStakeSeconds: 5 });
...
//# sourceMappingURL=pool-with-minimum-stake.test.js.map