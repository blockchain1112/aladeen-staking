...
describe("Stake and claim rewards from treasury", () => {
    ...
    it("Stake", async () => {
        ...
        const stakeEntryReceiptMintTokenAccountId = await (0, common_1.findAta)(stakeMintKeypair.publicKey, stakeEntryId, true);
    ...
    it("Unstake", async () => {
        ...
        const userReceiptMintTokenAccountId = await (0, common_1.findAta)(stakeMintKeypair.publicKey, provider.wallet.publicKey, true);
        const stakeEntryOriginalMintTokenAccountId = await (0, common_1.findAta)(originalMintId, stakeEntryData.pubkey, true);
        const stakeEntryReceiptMintTokenAccountId = await (0, common_1.findAta)(stakeMintKeypair.publicKey, stakeEntryData.pubkey, true);
...
//# sourceMappingURL=stake-receipts-claim-rewards-treasury.test.js.map