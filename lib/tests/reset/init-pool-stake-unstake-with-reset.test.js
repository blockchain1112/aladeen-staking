...
describe("Create stake pool", () => {
    ...
    it("Create Pool", async () => {
        let transaction;
        [transaction, stakePoolId] = await (0, src_1.createStakePool)(provider.connection, provider.wallet, { resetOnStake: true });
    ...
    it("Unstake", async () => {
        ...
        expect(stakeEntryData.parsed.totalStakeSeconds.toNumber()).toBeGreaterThan(0);
    });
...
//# sourceMappingURL=init-pool-stake-unstake-with-reset.test.js.map