...
const stakePoolAuthority = web3_js_1.Keypair.generate();
describe("Claim stake entry funds", () => {
    (0, globals_1.beforeAll)(async () => {
        provider = await (0, workspace_1.getProvider)();
        const fromAirdropSignature = await provider.connection.requestAirdrop(stakePoolAuthority.publicKey, web3_js_1.LAMPORTS_PER_SOL);
    ...
    (0, globals_1.test)("Create Pool", async () => {
        let transaction;
        [transaction, stakePoolId] = await (0, src_1.createStakePool)(provider.connection, new anchor_1.Wallet(stakePoolAuthority), {});
        await (0, utils_2.executeTransaction)(provider.connection, transaction, new anchor_1.Wallet(stakePoolAuthority));
    });
    ...
    (0, globals_1.test)("Claim funds from stake entry", async () => {
        ...
        await (0, transaction_1.withClaimStakeEntryFunds)(transaction, provider.connection, new anchor_1.Wallet(stakePoolAuthority), stakeEntryId, customPaymentMint);
        await (0, utils_2.executeTransaction)(provider.connection, transaction, new anchor_1.Wallet(stakePoolAuthority));
...
//# sourceMappingURL=claim-stake-entry-funds-pool-authority.test.js.map