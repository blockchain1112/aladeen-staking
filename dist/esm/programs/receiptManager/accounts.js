...
export const getAllreceiptManagers = async (connection) =>
  getAllOfType(connection, "receiptManager");
...
export const getAllRewardReceipts = async (connection) =>
  getAllOfType(connection, "rewardReceipt");
