...
import type { RewardAuthorityData, RewardDistributorData, RewardEntryData } from "./constants";
...
export declare const getRewardAuthority: (connection: Connection, rewardAuthority: PublicKey) => Promise<AccountData<RewardAuthorityData | null>>;
