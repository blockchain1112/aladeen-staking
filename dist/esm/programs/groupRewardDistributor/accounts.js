...
export const getGroupRewardCounter = async (connection, groupRewardCounterId) => {
...
export const getGroupRewardCounters = async (connection, groupRewardCounterIds) => {
    const program = groupRewardDistributorProgram(connection);
...
export const getGroupRewardEntries = async (connection, groupRewardEntryIds) => {
    const program = groupRewardDistributorProgram(connection);
...
export const getGroupRewardDistributor = async (connection, groupRewardDistributorId) => {
    const program = groupRewardDistributorProgram(connection);
...
export const getGroupRewardDistributors = async (connection, groupRewardDistributorIds) => {
    const program = groupRewardDistributorProgram(connection);
...
export const getGroupRewardEntriesForGroupRewardDistributor = async (connection, groupRewardDistributorId) => {
