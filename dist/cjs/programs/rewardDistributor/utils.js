...
const withRemainingAccountsForKind = async (
  transaction,
  connection,
  wallet,
  rewardDistributorId,
  ...
  switch (kind) {
    ...
    case constants_1.RewardDistributorKind.Treasury: {
      const rewardDistributorRewardMintTokenAccountId = await (0,
      ...
      const userRewardMintTokenAccountId = await (0, common_1.findAta)(
        rewardMint,
        wallet.publicKey,
        true
      );
