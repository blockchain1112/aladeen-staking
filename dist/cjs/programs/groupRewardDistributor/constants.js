...
exports.groupRewardDistributorProgram =
  exports.toGroupRewardDistributorPoolKind =
  exports.GroupRewardDistributorPoolKind =
  exports.toGroupRewardDistributorMetadataKind =
  exports.GroupRewardDistributorMetadataKind =
  exports.toGroupRewardDistributorKind =
  exports.GroupRewardDistributorKind =
  exports.GROUP_REWARD_DISTRIBUTOR_IDL =
  exports.GROUP_REWARD_DISTRIBUTOR_SEED =
  exports.GROUP_REWARD_COUNTER_SEED =
  exports.GROUP_REWARD_ENTRY_SEED =
  exports.GROUP_REWARD_MANAGER =
  exports.GROUP_REWARD_DISTRIBUTOR_ADDRESS =
    void 0;
const tslib_1 = require("tslib");
const common_1 = require("@cardinal/common");
const anchor_1 = require("@project-serum/anchor");
const web3_js_1 = require("@solana/web3.js");
const GROUP_REWARD_DISTRIBUTOR_TYPES = tslib_1.__importStar(
...
(function (GroupRewardDistributorKind) {
  ...
  GroupRewardDistributorKind[(GroupRewardDistributorKind["Treasury"] = 2)] =
    "Treasury";
})(
...
const toGroupRewardDistributorKind = (value) =>
  Object.values(GroupRewardDistributorKind).findIndex((x) => {
    var _a;
    return (
      x.toLowerCase() ===
      ((_a = Object.keys(value)[0]) === null || _a === void 0
        ? void 0
        : _a.toLowerCase())
    );
  }) + 1;
...
(function (GroupRewardDistributorMetadataKind) {
  GroupRewardDistributorMetadataKind[
    (GroupRewardDistributorMetadataKind["NoRestriction"] = 1)
  ] = "NoRestriction";
  GroupRewardDistributorMetadataKind[
    (GroupRewardDistributorMetadataKind["UniqueNames"] = 2)
  ] = "UniqueNames";
  GroupRewardDistributorMetadataKind[
    (GroupRewardDistributorMetadataKind["UniqueSymbols"] = 3)
  ] = "UniqueSymbols";
})(
  (GroupRewardDistributorMetadataKind =
    exports.GroupRewardDistributorMetadataKind ||
...
const toGroupRewardDistributorMetadataKind = (value) =>
  Object.values(GroupRewardDistributorMetadataKind).findIndex((x) => {
    var _a;
    return (
      x.toLowerCase() ===
      ((_a = Object.keys(value)[0]) === null || _a === void 0
...
exports.toGroupRewardDistributorMetadataKind =
  toGroupRewardDistributorMetadataKind;
var GroupRewardDistributorPoolKind;
(function (GroupRewardDistributorPoolKind) {
  GroupRewardDistributorPoolKind[
    (GroupRewardDistributorPoolKind["NoRestriction"] = 1)
  ] = "NoRestriction";
  GroupRewardDistributorPoolKind[
    (GroupRewardDistributorPoolKind["AllFromSinglePool"] = 2)
  ] = "AllFromSinglePool";
  GroupRewardDistributorPoolKind[
    (GroupRewardDistributorPoolKind["EachFromSeparatePool"] = 3)
  ] = "EachFromSeparatePool";
})(
  (GroupRewardDistributorPoolKind =
    exports.GroupRewardDistributorPoolKind ||
    (exports.GroupRewardDistributorPoolKind = {}))
);
const toGroupRewardDistributorPoolKind = (value) =>
  Object.values(GroupRewardDistributorPoolKind).findIndex((x) => {
    var _a;
    return (
      x.toLowerCase() ===
      ((_a = Object.keys(value)[0]) === null || _a === void 0
