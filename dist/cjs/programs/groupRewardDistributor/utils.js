...
const withRemainingAccountsForRewardKind = async (
  transaction,
  connection,
  wallet,
  ...
  switch (kind) {
    ...
    case constants_1.GroupRewardDistributorKind.Treasury: {
      const rewardDistributorGroupRewardMintTokenAccountId = await (0,
      ...
      const userGroupRewardMintTokenAccountId = await (0, common_1.findAta)(
        rewardMint,
        wallet.publicKey,
        true
      );
