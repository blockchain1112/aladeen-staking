...
exports.withCloseGroupRewardCounter =
  exports.withReclaimGroupFunds =
  exports.withUpdateGroupRewardDistributor =
  exports.withCloseGroupRewardEntry =
  exports.withUpdateGroupRewardEntry =
  exports.withCloseGroupRewardDistributor =
  exports.withClaimGroupRewards =
  exports.withInitGroupRewardEntry =
  exports.withInitGroupRewardDistributor =
    void 0;
...
const withInitGroupRewardDistributor = async (
  transaction,
  connection,
  wallet,
  params
) => {
  const [tx, groupRewardDistributorId] = await (0,
  instruction_1.initGroupRewardDistributor)(connection, wallet, {
    rewardAmount: params.rewardAmount || new anchor_1.BN(1),
    rewardDurationSeconds: params.rewardDurationSeconds || new anchor_1.BN(1),
    rewardKind:
      params.rewardKind || constants_1.GroupRewardDistributorKind.Mint,
    metadataKind:
      params.metadataKind ||
      constants_1.GroupRewardDistributorMetadataKind.NoRestriction,
    poolKind:
      params.poolKind ||
      constants_1.GroupRewardDistributorPoolKind.NoRestriction,
...
const withInitGroupRewardEntry = async (
  transaction,
  connection,
  wallet,
  params
) => {
  const groupRewardEntryId = (0, pda_2.findGroupRewardEntryId)(
    params.groupRewardDistributorId,
    params.groupEntryId
  );
  const groupRewardCounterId = (0, pda_2.findGroupRewardCounterId)(
    params.groupRewardDistributorId,
    wallet.publicKey
  );
  const groupRewardCounter = await (0, common_1.tryGetAccount)(() =>
    (0, accounts_1.getGroupRewardCounter)(connection, groupRewardCounterId)
  );
  if (!groupRewardCounter) {
    transaction.add(
      await (0, instruction_1.initGroupRewardCounter)(connection, wallet, {
  ...
  const stakeEntries = params.stakeEntries.map(
    ({ stakeEntryId, originalMint, rewardDistributorId }) => {
      const rewardEntryId = (0, pda_1.findRewardEntryId)(
        rewardDistributorId,
        stakeEntryId
      );
      const originalMintMetadata = (0, common_1.findMintMetadataId)(
        originalMint
      );
      return {
        stakeEntryId,
  ...
  transaction.add(
    await (0, instruction_1.initGroupRewardEntry)(connection, wallet, {
      groupRewardDistributorId: params.groupRewardDistributorId,
...
const withClaimGroupRewards = async (
  transaction,
  connection,
  wallet,
  params
) => {
  const groupRewardDistributorData = await (0, common_1.tryGetAccount)(() =>
    (0, accounts_1.getGroupRewardDistributor)(
      connection,
      params.groupRewardDistributorId
    )
  );
  if (groupRewardDistributorData) {
    ...
    utils_1.withRemainingAccountsForRewardKind)(
      transaction,
      connection,
      wallet,
      groupRewardDistributorData.pubkey,
      (0, constants_1.toGroupRewardDistributorKind)(
    ...
    transaction.add(
      await (0, instruction_1.claimGroupRewards)(connection, wallet, {
        groupEntryId: params.groupEntryId,
        groupRewardDistributorId: params.groupRewardDistributorId,
        groupRewardEntryId,
        groupRewardCounterId,
...
const withCloseGroupRewardDistributor = async (
  transaction,
  connection,
  wallet,
  params
  ...
  if (groupRewardDistributorData) {
    ...
    transaction.add(
      await (0, instruction_1.closeGroupRewardDistributor)(connection, wallet, {
        groupRewardDistributorId: params.groupRewardDistributorId,
        rewardMintId: groupRewardDistributorData.parsed.rewardMint,
        remainingAccountsForKind,
      })
...
const withUpdateGroupRewardEntry = async (
  transaction,
  connection,
  wallet,
  params
  ...
  return transaction.add(
    await (0, instruction_1.updateGroupRewardEntry)(connection, wallet, {
      groupRewardDistributorId: params.groupRewardDistributorId,
...
const withCloseGroupRewardEntry = async (
  transaction,
  connection,
  wallet,
  params
  ...
  return transaction.add(
    await (0, instruction_1.closeGroupRewardEntry)(connection, wallet, {
      groupEntryId: params.groupEntryId,
      groupRewardDistributorId: params.groupRewardDistributorId,
      groupRewardEntryId,
      groupRewardCounterId,
...
const withUpdateGroupRewardDistributor = async (
  transaction,
  connection,
  wallet,
  params
  ...
  return transaction.add(
    await (0, instruction_1.updateGroupRewardDistributor)(connection, wallet, {
      groupRewardDistributorId: params.groupRewardDistributorId,
      rewardAmount: params.rewardAmount || new anchor_1.BN(1),
      rewardDurationSeconds: params.rewardDurationSeconds || new anchor_1.BN(1),
      metadataKind:
...
const withReclaimGroupFunds = async (
  transaction,
  connection,
  wallet,
  params
  ...
  const groupRewardDistributorTokenAccountId = await (0, common_1.findAta)(
    groupRewardDistributorData.parsed.rewardMint,
    groupRewardDistributorData.pubkey,
    true
  );
  ...
  return transaction.add(
    await (0, instruction_1.reclaimGroupFunds)(connection, wallet, {
      groupRewardDistributorId: params.groupRewardDistributorId,
...
const withCloseGroupRewardCounter = async (
  transaction,
  connection,
  wallet,
  params
  ...
  transaction.add(
    await (0, instruction_1.closeGroupRewardCounter)(connection, wallet, {
      groupRewardDistributorId: params.groupRewardDistributorId,
      groupRewardCounterId,
      authority: wallet.publicKey,
    })
