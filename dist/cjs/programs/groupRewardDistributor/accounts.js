...
const getGroupRewardDistributor = async (connection, groupRewardDistributorId) => {
    const program = (0, constants_1.groupRewardDistributorProgram)(connection);
...
const getGroupRewardDistributors = async (connection, groupRewardDistributorIds) => {
    const program = (0, constants_1.groupRewardDistributorProgram)(connection);
...
const getGroupRewardEntriesForGroupRewardDistributor = async (connection, groupRewardDistributorId) => {
