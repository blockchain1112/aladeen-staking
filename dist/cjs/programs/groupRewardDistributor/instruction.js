...
exports.reclaimGroupFunds =
  exports.updateGroupRewardDistributor =
  exports.closeGroupRewardCounter =
  exports.closeGroupRewardEntry =
  exports.updateGroupRewardEntry =
  exports.closeGroupRewardDistributor =
  exports.claimGroupRewards =
  exports.initGroupRewardEntry =
  exports.initGroupRewardCounter =
  exports.initGroupRewardDistributor =
    void 0;
...
const initGroupRewardDistributor = async (connection, wallet, params) => {
  ...
  signers.push(id);
  const groupRewardDistributorId = (0, pda_1.findGroupRewardDistributorId)(
    id.publicKey
  );
...
const initGroupRewardEntry = (connection, wallet, params) => {
  ...
  return program.methods
    ...
    .accounts({
      ...
      groupRewardCounter: params.groupRewardCounterId,
      authority:
        (_a = params.authority) !== null && _a !== void 0
          ? _a
          : wallet.publicKey,
      systemProgram: web3_js_1.SystemProgram.programId,
    })
