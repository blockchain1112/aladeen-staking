...
exports.getClaimedRewards =
  ...
  exports.findStakeEntryIdFromMint =
  exports.withRemainingAccountsForUnstake =
...
const withRemainingAccountsForUnstake = async (
  transaction,
  connection,
  wallet,
  stakeEntryId,
  ...
  if (receiptMint) {
    const stakeEntryReceiptMintTokenAccount = await (0,
...
const findStakeEntryIdFromMint = async (
  ...
  return (0, pda_2.findStakeEntryId)(
    wallet,
    stakePoolId,
    originalMintId,
    isFungible
...
const getTotalStakeSeconds = async (connection, stakeEntryId) => {
  ...
  const stakePoolProgram = new anchor_1.Program(
    _1.STAKE_POOL_IDL,
...
const getActiveStakeSeconds = async (connection, stakeEntryId) => {
  ...
  return parsed.lastStaker
    ? new anchor_1.BN(UTCNow - lastStakedAt)
    : new anchor_1.BN(0);
};
exports.getActiveStakeSeconds = getActiveStakeSeconds;
const getUnclaimedRewards = async (connection, stakePoolId, distributorId) => {
  var _a;
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
  const provider = new anchor_1.AnchorProvider(connection, null, {});
  const rewardDistributor = new anchor_1.Program(
    rewardDistributor_1.REWARD_DISTRIBUTOR_IDL,
    rewardDistributor_1.REWARD_DISTRIBUTOR_ADDRESS,
    provider
  );
  const rewardDistributorId = (0, pda_1.findRewardDistributorId)(
    stakePoolId,
    distributorId
  );
  ...
  return parsed.maxSupply
    ? new anchor_1.BN(
        ((_a = parsed.maxSupply) === null || _a === void 0
          ? void 0
          : _a.toNumber()) - parsed.rewardsIssued.toNumber()
      )
    : new anchor_1.BN(0);
};
exports.getUnclaimedRewards = getUnclaimedRewards;
const getClaimedRewards = async (connection, stakePoolId, distributorId) => {
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
  const provider = new anchor_1.AnchorProvider(connection, null, {});
  const rewardDistributor = new anchor_1.Program(
