...
const getAllreceiptManagers = async (connection) => (0, exports.getAllOfType)(connection, "receiptManager");
...
const getAllRewardReceipts = async (connection) => (0, exports.getAllOfType)(connection, "rewardReceipt");
...
const getClaimableRewardReceiptsForManager = async (connection, receiptManagerId) => {
    const ReceiptManagerData = await (0, common_1.tryGetAccount)(() => (0, exports.getReceiptManager)(connection, receiptManagerId));
    if (!ReceiptManagerData) {
