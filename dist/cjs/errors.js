...
const handleError = (
  ...
  options = {
    programIdls: [
      {
        programId: stakePool_1.STAKE_POOL_ADDRESS,
        idl: stakePool_1.STAKE_POOL_IDL,
      },
      {
        programId: rewardDistributor_1.REWARD_DISTRIBUTOR_ADDRESS,
        idl: rewardDistributor_1.REWARD_DISTRIBUTOR_IDL,
      },
    ],
  ...
  const programIdls =
    (_a = options.programIdls) !== null && _a !== void 0 ? _a : [];
  const additionalErrors =
    (_b = options.additionalErrors) !== null && _b !== void 0 ? _b : [];
  const hex =
  ...
  const logs =
    (_f =
      (_e =
        (_d = e === null || e === void 0 ? void 0 : e.logs) !== null &&
        _d !== void 0
          ? _d
          : [e === null || e === void 0 ? void 0 : e.message]) !== null &&
      _e !== void 0
        ? _e
        : [e.toString()]) !== null && _f !== void 0
      ? _f
      : [];
  const matchedErrors = [
    ...[
            ...
            logs === null || logs === void 0
              ...
              : logs.some(
                  (l) =>
                    (l === null || l === void 0
                      ? void 0
                      : l.includes(programId.toString())) &&
                    l.includes("failed")
                ),
          // match error with decimal
          errorMatch:
            (_b =
              (_a = idl.errors) === null || _a === void 0
                ? void 0
                : _a.find((err) => err.code === dec)) === null || _b === void 0
              ? void 0
              : _b.msg,
        };
      }),
      {
        ...
        errorMatch:
          (_g = additionalErrors.find((err) => err.code === dec.toString())) ===
            null || _g === void 0
            ? void 0
            : _g.message,
      },
    ...
    ...[
      {
        programMatch: true,
        errorMatch:
          (_h = additionalErrors.find((err) => {
            var _a, _b;
            // message includes error
            return (
              ((_a = e === null || e === void 0 ? void 0 : e.message) ===
                null || _a === void 0
                ? void 0
                : _a.includes(err.code)) ||
              // toString includes error
              e.toString().includes(err.code) ||
              // any log includes error
              ((_b = e === null || e === void 0 ? void 0 : e.logs) === null ||
              _b === void 0
                ? void 0
                : _b.some((l) => l.toString().includes(err.code)))
            );
          })) === null || _h === void 0
            ? void 0
            : _h.message,
                ...
                : _a.find((err) => {
                    ...
                    return (
                      ((_a =
                        ...
                        null || _a === void 0
                        ? void 0
                        : _a.includes(err.code.toString())) ||
                      // toString includes error
                      e.toString().includes(err.code.toString()) ||
                      // any log includes error
                      ((_b = e === null || e === void 0 ? void 0 : e.logs) ===
                        null || _b === void 0
                        ? void 0
                        : _b.some((l) =>
  ...
  return (
    ((_j = matchedErrors.find((e) => e.programMatch && e.errorMatch)) ===
      null || _j === void 0
      ? void 0
      : _j.errorMatch) ||
    ((_k = matchedErrors.find((e) => e.errorMatch)) === null || _k === void 0
      ? void 0
      : _k.errorMatch) ||
    fallBackMessage
  );
